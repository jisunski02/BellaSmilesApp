...
public class ScheduleAdapter extends RecyclerView.Adapter<ScheduleAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.linearTimeSchedule.setBackgroundResource(selected_position == position ? R.drawable.selected_schedule_bg: R.drawable.edittext_bg);
        holder.tvTimeSchedule.setTextColor(selected_position == position ? Color.WHITE : Color.BLACK);

        holder.tvTimeSchedule.setText(scheduleModel.getStartTime()+" "+scheduleModel.getEndTime());
